...
RUN apt update \
    && apt-get install -y curl git vim unzip libxslt-dev libbz2-dev libicu-dev postgresql postgresql-contrib libmemcached-dev php7.2-dev php7.2-mongo php-xdebug php7.2-bcmath \
